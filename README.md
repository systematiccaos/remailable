...
> **Early stage** — this is a proof of concept written over a weekend. Large parts of the codebase were generated by AI (Sisyphus via OhMyOpenCode). It syncs INBOX, reads emails, and renders HTML — but there's no compose, no SMTP, no multi-folder sync yet. Expect rough edges.
